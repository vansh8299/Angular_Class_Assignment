...
export class AnnouncementService {
  private announcementsUrl = 'api/announcement';
  ...
  updateAnnouncements(announcement: Interface): Observable<any> {
    const url = `${this.announcementsUrl}/${announcement.id}`;
    return this.http
      .put(url, announcement, this.httpOptions)
      .pipe(catchError(this.handleError<any>('updateAnnouncements')));
  }
